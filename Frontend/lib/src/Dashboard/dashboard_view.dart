                  ...
                  pieTouchData: PieTouchData(
                    touchCallback: (FlTouchEvent event, pieTouchResponse) {
                      setState(() {
                        ...
                        DashboardView.touchedIndex = pieTouchResponse
              ...
              Column(
                  ...
                  children: <Widget>[
                    Indicator(
                      ...
                      textColor: DashboardView.touchedIndex == 0 ? (_settingsController.themeMode == ThemeMode.dark ? Colors.white : Colors.black) : Colors.grey,
                    ),
                     Indicator(
                      ...
                      textColor: DashboardView.touchedIndex == 1 ? (_settingsController.themeMode == ThemeMode.dark ? Colors.white : Colors.black) : Colors.grey,
                    ),
                    Indicator(
                      ...
                      textColor: DashboardView.touchedIndex == 2 ? (_settingsController.themeMode == ThemeMode.dark ? Colors.white : Colors.black) : Colors.grey,
                    ),
                   Indicator(
                      ...
                      textColor: DashboardView.touchedIndex == 3 ? (_settingsController.themeMode == ThemeMode.dark ? Colors.white : Colors.black) : Colors.grey,
                    ),
                  ],
                ),
            ],
        ...
        switch (i) {
          case 0:
            return PieChartSectionData(
              color: color0,
              value: val0,
              titleStyle: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.bold),
              title: title0,
