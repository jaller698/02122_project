...
Future<bool> getUserSession(String username, String password) async {
  http.Request request = http.Request("GET", Uri.parse('${SettingsController.address}/users'));

  var _hashedPassword = sha256.convert(utf8.encode(password));
  request.body = jsonEncode(<String, String>{'User': username, 'Password': _hashedPassword.toString()});
